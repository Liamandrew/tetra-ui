...
export const InputPressable = ({
  ...
  return (
    <Pressable
      ...
      className={cn(
        "flex min-h-14 w-full grow flex-row items-center gap-1 rounded-md border border-input bg-transparent px-3 py-2 shadow-xs transition-color active:bg-accent/90 disabled:opacity-50 dark:active:bg-accent/50",

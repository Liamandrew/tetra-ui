...
testra-ui is built for React 19 and relies on features only available in the [New Architecture](https://reactnative.dev/architecture/landing-page) of React Native.
